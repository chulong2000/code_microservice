CREATE OR ALTER PROCEDURE dbo.spEducationLevel_ExistsName
    @Name      NVARCHAR(100),
...
CREATE OR ALTER PROCEDURE dbo.spEducationLevel_Insert
...
CREATE OR ALTER PROCEDURE dbo.spEducationLevel_Update
    @Id UNIQUEIDENTIFIER, @Name NVARCHAR(100), @Description NVARCHAR(500) = NULL,
...
CREATE OR ALTER PROCEDURE dbo.spEducationLevel_SelectList
...
CREATE OR ALTER PROCEDURE dbo.spEducationLevel_SelectById
    @Id UNIQUEIDENTIFIER
AS
BEGIN
    SET NOCOUNT ON;
