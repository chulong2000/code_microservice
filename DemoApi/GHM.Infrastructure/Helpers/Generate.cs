...
namespace GHM.Infrastructure.Helpers
{
    public static class Generate
    {
        ...
        public static string ReturnCode()
        {
            ...
            //if(Val(s0) < 10) s0 = "0" + s0
            if (Convert.ToInt16(month) < 10) month = "0" + month;
            if (Convert.ToInt16(day) < 10) day = "0" + day;
            if (Convert.ToInt16(hour) < 10) hour = "0" + hour;
            if (Convert.ToInt16(minute) < 10) minute = "0" + minute;
            if (Convert.ToInt16(second) < 10) second = "0" + second;
